...
\begin{itemize}
  ...
  \item \textbf{Diagrama de Gantt:}\\
    \href{https://docs.google.com/spreadsheets/d/19SBDgHSgRw6bz_plAlHYkfWy23hx8tOTT-GIoEdbngE/edit?usp=sharing}{\textit{Diagrama de Gantt -- AttentiON (Google Sheets)}}\\
...
\begin{figure}[H]
  ...
  % TODO: añadir imagen real → \includegraphics[width=0.35\textwidth]{figuras/lumosity.png}
  \framebox[6cm]{\parbox[c][3cm]{5.5cm}{\centering\small\textcolor{gray}{[Captura: Lumosity]}}}
...
\begin{figure}[H]
  \centering
  % TODO: añadir imagen real → \includegraphics[width=0.35\textwidth]{figuras/cognifit.png}
  \framebox[6cm]{\parbox[c][3cm]{5.5cm}{\centering\small\textcolor{gray}{[Captura: CogniFit]}}}
...
\begin{figure}[H]
  \centering
  % TODO: añadir imagen real → \includegraphics[width=0.35\textwidth]{figuras/brainhq.png}
  \framebox[6cm]{\parbox[c][3cm]{5.5cm}{\centering\small\textcolor{gray}{[Captura: BrainHQ]}}}
...
\begin{figure}[H]
  \centering
  % TODO: añadir imagen real → \includegraphics[width=0.35\textwidth]{figuras/neuroracer.png}
  \framebox[6cm]{\parbox[c][3cm]{5.5cm}{\centering\small\textcolor{gray}{[Captura: NeuroRacer]}}}
...
La planificación temporal de \textit{AttentiON} se ha articulado en cuatro
grandes fases que abarcan desde junio de 2025 hasta junio de 2026. La
herramienta principal de seguimiento ha sido un diagrama de Gantt, disponible
en el siguiente enlace:

\begin{center}
\href{https://docs.google.com/spreadsheets/d/19SBDgHSgRw6bz_plAlHYkfWy23hx8tOTT-GIoEdbngE/edit?usp=sharing}%
{\textit{Diagrama de Gantt -- AttentiON (Google Sheets)}}
\end{center}

A continuación se presenta el estado actual de cada tarea, con el porcentaje
de avance real a la fecha de entrega de la memoria (mayo de 2026):

\begin{table}[H]
\centering
\caption{Estado de avance del proyecto según el diagrama de Gantt (mayo 2026)}
\label{tab:gantt}
\renewcommand{\arraystretch}{1.25}
\begin{tabularx}{\textwidth}{|l|X|l|l|r|}
\hline
\textbf{ID} & \textbf{Tarea} & \textbf{Inicio} & \textbf{Fin} & \textbf{Avance} \\
\hline
\multicolumn{5}{|l|}{\textbf{Fase 1 — Investigación y definición}} \\
\hline
...
\hline
\multicolumn{5}{|l|}{\textbf{Fase 2 — Diseño}} \\
\hline
...
\hline
\multicolumn{5}{|l|}{\textbf{Fase 3 — Desarrollo}} \\
\hline
...
\hline
\multicolumn{5}{|l|}{\textbf{Fase 4 — Validación y entrega}} \\
\hline
...
El grado de avance refleja el estado real del proyecto a mayo de 2026. La
programación base y los minijuegos de memoria han quedado completados al
100\,\%, siendo la categoría más avanzada y que ha servido como base técnica
para el resto. Las categorías de planificación y gestión emocional presentan
un avance del 80\,\%, mientras que atención y control de impulsos se sitúan
en torno al 60\,\%, condicionadas por la mayor complejidad de sus mecánicas
y por la concentración de trabajo técnico en el tramo final del curso.
La fase 4 de validación y entrega formal queda pendiente y se abordará en
junio de 2026.
...
\hline
\multicolumn{2}{|r|}{\textbf{Total directo}} & \textbf{1.300{,}00} \\
\hline
